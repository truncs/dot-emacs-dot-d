...
(custom-set-variables
 ...
 '(package-selected-packages
   '(dired-sidebar jedi gnu-elpa-keyring-update ack docker-tramp rust-mode yaml-mode multi-term yasnippet-snippets markdown-mode interleave company-mode hl-todo magit ac-dabbrev go-autocomplete auto-complete-config smex ace-jump-mode go-mode auto-complete dracula-theme use-package evil))
 '(tool-bar-mode nil))
